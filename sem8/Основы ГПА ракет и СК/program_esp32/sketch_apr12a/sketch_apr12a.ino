...
#def ESP32
  ...
  ESP8266WebServer e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\DU16_I2C.ino e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\DU16_led_control.ino e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\DU16_memory_save.ino e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\du16_modbus_holding.ino e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\DU16_reSetup.ino e:\BMSTU\for_study\sem8\Основы ГПА ракет и СК\du16_modbus_holding\DU16_acc_filter.inoserver(80);
#endif

uint8_t button = 0; // Button  is connected between PIN D3 and GND

const char* ssid     = "Kapibara 2";
const char* password = "Pidar123";
